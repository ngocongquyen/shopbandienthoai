...
Validator.isNumber = function(selector) {
    return {
        selector: selector,
        test: function(value) {
            return value.match(/^[0-9]+$/) ? undefined : 'Vui lòng nhập giá trị là số'
        }
    }
}
...
Validator.isPhone = function(selector) {
    return {
        selector: selector,
        test: function(value) {
            return value.length>9 && value.match(/^[0-9]+$/) ? undefined : 'Vui lòng nhập số điện thoại lớn hơn 9 số'
        }
    }
}
Validator.isImage = function(selector) {
    return {
        selector: selector,
        test: function(value) {
            return value.match(/\.(jpg|jpeg|png|gif)$/) ? undefined : 'Vui lòng kiểm tra lại hình ảnh';
        }
    }
}
