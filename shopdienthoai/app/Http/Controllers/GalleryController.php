        ...
        if($gallery_count>0) {
            ...
            foreach($gallery as $key => $gal) {
                ...
                $output.= '
                    ...
                    <td>
                    <img src="'.url('public/uploads/gallery/'.$gal->gallery_image).'" class="img-thumbnail" style="width:120px;height:120px">
                    <input type="file" class="file_image" style="width:40%" data-gal_id="'.$gal->gallery_id.'" id="file-'.$gal->gallery_id.'" name="file" accept="image/*">
                    </td>
                    <td><button type="button" class="btn btn-xs btn-danger delete-gallery" data-gal_id="'.$gal->gallery_id.'">Xóa</button></td>
                    </tr>
                ';
